...
public class FragmentThongKe2 extends Fragment implements View.OnClickListener{
    ImageButton imgBtnAdd, imgBtnEdit, imgBtnDelete;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_thongkebieudoduong, container, false);
